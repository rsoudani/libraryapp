...
public class JsonTestUtils {
    ...
    public static void assertJsonMatchesFileContent(final String actualJson, final String filename){
        assertJsonMatchesExpectedJson(actualJson, readJsonFile(filename));
    }
